                    ...
                    <div>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <li className="li-resume">Worked as an engineer for a software company focused on improving women’s health and prenatal care. 
                                            ...
                                            in delivering quality services to their patients.
                                        </li>
                                        <li className="li-resume">Wrote and debugged code in Javascript, Ruby on Rails, Vue, and AngularJS for an application used 
                                            nationwide to support healthcare providers and patients during ob-gyn visits
                                        </li>
                                        <li className="li-resume">Translated parts of our code-base from an AngularJS to a Vue framework</li>
                                        <li className="li-resume">Was a core engineer developing an application advancing women’s health research, 
                                ...
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Instructor, Western Connecticut State University, Danbury, CT </td>
                                    <td className="resume-date resume-section-bold">01/2017-12/2018</td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Teaching Assistant & Graduate Council Fellow, Stony Brook University, Stony Brook, NY</td>
                                    <td className="resume-date resume-section-bold"> 08/2011-05/2016</td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Google Cybersecurity Professional Certificate</td>
                                    <td className="resume-date resume-section-bold">01/2024</td>
                                </tr>
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">HarvardX CS50x Intro. to Computer Science Verified Certificate</td>
                                    <td className="resume-date resume-section-bold">12/2023</td>
                                </tr>
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Google/Coursera Crash Course on Python Certificate</td>
                                    <td className="resume-date resume-section-bold">09/2020-10/2020</td>
                                </tr>
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Flatiron School Access Labs, Brooklyn, NY</td>
                                    <td className="resume-date resume-section-bold">10/2019-02/2020</td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Stony Brook University, Stony Brook, NY</td>
                                    <td className="resume-date resume-section-bold">08/2011-12/2017</td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">Stony Brook University, Stony Brook, NY</td>
                                    <td className="resume-date resume-section-bold">08/2009-12/2010</td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td className="resume-paragraph resume-section-bold">DePaul University, Chicago, IL</td>
                                    <td className="resume-date resume-section-bold">09/2004-06/2008</td>
                                </tr>
                                <tr>
                                    <td>
